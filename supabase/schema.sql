...
VALUES
  ...
  ('CSE', 'CSE', 'Computer Science & Engineering', 'The core computing track — algorithms, systems, networks, and software engineering. The largest resource-sharing department on ritresources, with the deepest archive of PYQs and lab manuals.', 'linear-gradient(135deg,#0B1E4D,#1E4FDB)', 2),
